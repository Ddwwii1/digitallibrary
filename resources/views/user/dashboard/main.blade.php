                ...
                <div class="row align-items-center">
                    <div class="col-xl-6 col-lg-7 col-md-8">
                        <div class="hero__caption">
                            <span data-animation="fadeInLeft" data-delay=".2s">Perpustakaan Digital Terbaik</span>
                            <h1 data-animation="fadeInLeft" data-delay=".4s">Mari menjelajahi jendela dunia bersama!</h1>
                            <!-- Hero-btn -->
                            <div class="hero__btn">
                                <a href="industries.html" class="btn hero-btn"  data-animation="fadeInLeft" data-delay=".8s">Mulai mencari</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-6 col-lg-5">
                        <div class="hero-man d-none d-lg-block f-right" data-animation="jello" data-delay=".4s">
                            {{-- <img src="{{ asset('template-user/assets/img/hero/hero.jpg') }}" alt="" width="100%"> --}}
                        </div>
                    </div>
                </div>
            </div>
...
<!-- Categories Area End -->
<!--? Count Down Start -->
<div class="count-down-area pt-90 pb-60 section-bg" data-background="{{ asset('template-user/assets/img/gallery/section_bg01.png') }}">
    <div class="container">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-xl-4 col-lg-4 col-md-6">
                ...
                <div class="single-course mb-40">
                    <div class="course-img">
                        <img src="{{ asset('template-user/assets/img/gallery/popular_sub1.png') }}" alt="">
                    </div>
            ...
            <div class="col-xl-4 col-lg-4 col-md-6">
                ...
                <div class="single-course mb-40">
                    <div class="course-img">
                        <img src="{{ asset('template-user/assets/img/gallery/popular_sub2.png') }}" alt="">
                    </div>
                    <div class="course-caption">
                        <div class="course-cap-top">
            ...
            <div class="col-xl-4 col-lg-4 col-md-6">
                ...
                <div class="single-course mb-40">
                    <div class="course-img">
                        <img src="{{ asset('template-user/assets/img/gallery/popular_sub3.png') }}" alt="">
                    </div>
                    <div class="course-caption">
                        <div class="course-cap-top">
...
<!-- Popular Course End -->
<!--? Team Ara Start -->
{{-- <div class="team-area pt-160 pb-160 section-bg" data-background="{{ asset('template-user/assets/img/gallery/section_bg02.png') }}">
    <div class="container">
        <div class="row justify-content-center">
            <div class="cl-xl-7 col-lg-8 col-md-10">
                <!-- Section Tittle -->
        ...
        <div class="row">
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="single-team mb-30">
                    <div class="team-img">
                        <img src="{{ asset('template-user/assets/img/gallery/team1.png') }}" alt="">
                        <!-- Blog Social -->
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="single-team mb-30">
                    <div class="team-img">
                        <img src="{{ asset('template-user/assets/img/gallery/team2.png') }}" alt="">
                        <!-- Blog Social -->
                        <ul class="team-social">
                            <li><a href="#"><i class="fab fa-facebook-f"></i></a></li>
                            <li><a href="#"><i class="fab fa-twitter"></i></a></li>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="single-team mb-30">
                    <div class="team-img">
                        <img src="{{ asset('template-user/assets/img/gallery/team3.png') }}" alt="">
                        <!-- Blog Social -->
                        <ul class="team-social">
                            <li><a href="#"><i class="fab fa-facebook-f"></i></a></li>
                            <li><a href="#"><i class="fab fa-twitter"></i></a></li>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="single-team mb-30">
                    <div class="team-img">
                        <img src="{{ asset('template-user/assets/img/gallery/team4.png') }}" alt="">
                        <!-- Blog Social -->
                        <ul class="team-social">
                            <li><a href="#"><i class="fab fa-facebook-f"></i></a></li>
                            <li><a href="#"><i class="fab fa-twitter"></i></a></li>
        ...
        <div class="row">
            <div class="col-xl-6 col-lg-6 col-md-6">
                <div class="home-blog-single mb-30">
                    <div class="blog-img-cap">
                        <div class="blog-img">
                            <img src="{{ asset('template-user/assets/img/gallery/home-blog1.png') }}" alt="">
                            <!-- Blog date -->
            ...
            <div class="col-xl-6 col-lg-6 col-md-6">
                <div class="home-blog-single mb-30">
                    <div class="blog-img-cap">
                        <div class="blog-img">
                            <img src="{{ asset('template-user/assets/img/gallery/home-blog2.png') }}" alt="">
                            <!-- Blog date -->
                            <div class="blog-date text-center">
                                <span>24</span>
                                <p>Now</p>
