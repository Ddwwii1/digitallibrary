    ...
    <section class="section">
      <div class="section-header">
        ...
        <div class="section-header-breadcrumb">
          ...
          <div class="breadcrumb-item active"><a href="{{ route('users') }}">Petugas</a></div>
                    ...
                    <tr role="row" class="odd">
                        ...
                        <td class="d-flex">
                            <a href="{{ route('usersShow', $us->id) }}" style="margin-right: 2px;" class="btn btn-primary"><i class="menu-icon fa fa-eye"></i></a>
                                ...
                                <a href="{{ route('usersDelete', $us->id) }}" style="margin-right: 2px;" class="btn btn-danger" onclick="return confirm('Apakah anda ingin menghapus data')"><i class="fa fa-trash"></i></a>
                        </td>
