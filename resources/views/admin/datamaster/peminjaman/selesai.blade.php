                  ...
                  <div id="table-1_wrapper" class="dataTables_wrapper container-fluid dt-bootstrap4 no-footer"><div class="row"><div class="col-sm-12 col-md-6"><div class="dataTables_length" id="table-1_length"><label>Show <select name="table-1_length" aria-controls="table-1" class="form-control form-control-sm"><option value="10">10</option><option value="25">25</option><option value="50">50</option><option value="100">100</option></select> entries</label></div></div><div class="col-sm-12 col-md-6"><div id="table-1_filter" class="dataTables_filter"><label>Search:<input type="search" class="form-control form-control-sm" placeholder="" aria-controls="table-1"></label></div></div></div><div class="row"><div class="col-sm-12"><table class="table table-striped dataTable no-footer" id="table-1" role="grid" aria-describedby="table-1_info">
                    <thead>
                      <tr role="row"><th class="text-center sorting_asc" tabindex="0" aria-controls="table-1" rowspan="1" colspan="1" aria-sort="ascending" aria-label="
                        ...
                        <th class="sorting" tabindex="0" aria-controls="table-1" rowspan="1" colspan="1" aria-label="Task Name: activate to sort column ascending" style="width: 123.677px;">Id Peminjama</th>
                        <th class="sorting_disabled" rowspan="1" colspan="1" aria-label="Progress" style="width: 65.0625px;">Tgl. Peminjaman</th>
                        <th class="sorting_disabled" rowspan="1" colspan="1" aria-label="Members" style="width: 90.312px;">Tgl Pengembalian</th>
                        <th class="sorting" tabindex="0" aria-controls="table-1" rowspan="1" colspan="1" aria-label="Due Date: activate to sort column ascending" style="width: 110.6667px;">Tgl. Kembali</th>
                        <th class="sorting" tabindex="0" aria-controls="table-1" rowspan="1" colspan="1" aria-label="Due Date: activate to sort column ascending" style="width: 66.6667px;">Denda</th>
                    ...
                    <tr @if ($s->denda!= 0) class="table-danger" @endif role="row" class="odd">
                        <td class="sorting_1 align-middle">
                            {{ $s->$key+1 }}
                        </td>
                        <td class="align-middle">{{ $s->id_peminjaman }}</td>
                        <td class="align-middle">
                            {{ $s->tanggal_peminjaman }}
                        </td>
                        <td class="align-middle">{{ $s->tanggal_pengembalian }}</td>
                        <td class="align-middle">{{ $s->tanggal_kembali }}</td>
                        <td>{{ number_format($s->denda) }}</td>
                        <td class="align-middle"><span class="btn btn-success">{{ $s->status_peminjaman }}</span></td>
                         <td class="d-flex">
                            <a href="{{ route('showPeminjaman', $s->id_peminjaman) }}" style="margin-right: 2px;" class="btn btn-primary"><i class="menu-icon fa fa-eye"></i></a>
