              ...
              <div class="card">
                ...
                <form action="" method="" enctype="">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="judul" class="form-control" required disabled autofocus  value="{{ (old('judul')) ? old('judul') : $buku->judul }}">
                  ...
                  <div class="form-group">
                    ...
                    <input type="file" name="cover" class="form-control" required disabled>
                    <div class="invalid-feedback">
                        masukkan cover
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    <label>Penulis</label>
                    <input type="text" name="penulis" class="form-control" required disabled  value="{{ (old('penulis')) ? old('penulis') : $buku->penulis }}">
                    <div class="invalid-feedback">
                        masukkan penulis
                    </div>
                  </div>
                  <div class="form-group">
                    ...
                    <input type="text" name="penerbit" class="form-control" required disabled  value="{{ (old('penerbit')) ? old('penerbit') : $buku->penerbit }}">
                    <div class="invalid-feedback">
                        masukkan penerbit
                    </div>
                  </div>
                  <div class="form-group">
                    ...
                    <input type="text" name="tahun_terbit" class="form-control" required disabled  value="{{ (old('tahun_terbit')) ? old('tahun_terbit') : $buku->tahun_terbit }}">
                    <div class="invalid-feedback">
                        masukkan tahun
                    </div>
                  </div>
                  <div class="form-group">
                    <label>Stok</label>
                    <input type="text" name="stok" class="form-control" required disabled  value="{{ (old('stok')) ? old('stok') : $buku->stok }}">
                    <div class="invalid-feedback">
                        masukkan stok
                    </div>
                  </div>
                  <div class="form-group">
                    ...
                    <select required disabled class="form-control select2 select2-hidden-accessible" name="kategori_id" tabindex="-1" aria-hidden="true">
